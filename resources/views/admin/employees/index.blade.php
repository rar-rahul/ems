                        ...
                        <table class="table table-bordered table-hover" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.employees.edit', $employee->employee_id) }}" class="btn btn-flat btn-info">Edit Profile</a>
                                        <button 
                                        ...
                                        <div class="modal-content">
                                            <div class="card card-danger">
                                                ...
                                                <div class="card-body text-center d-flex" style="justify-content: center">
                                                    ...
                                                    <form 
                                                    action="{{ route('admin.employees.delete', $employees->get($i-1)->employee_id) }}"
                                                    method="POST"
                                                    >
                                                    @csrf
                                                    @method('DELETE')
